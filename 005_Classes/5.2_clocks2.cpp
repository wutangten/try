#include <iostream>
#include <string> // Contains to_string() function
using namespace std;

class clockType
{
public:
	/* Put the constructor(s) first
		Note:
			The construct's name is as same as the class's name.
			No data type for constructor(s).
	*/
	// default constructor(no parameters)
	clockType() // sets all fields to default values, i.e sets all fields to 0
	{
		hr = min = sec = 0;
	}
	...
	void incHr()
	{
		hr = (hr + 1) % 24;	// increment by 1 and makes it less than 24
	}
	...
	//the to_string() function from <string>-library, it is used that converts an integer into a string
